...
- [DomScan MCP](https://github.com/estevecastells/domscan-mcp) - Domain intelligence: availability across 1500+ TLDs, DNS, WHOIS/RDAP, SSL, subdomains, valuation, email security, and typosquatting/brand protection. Hosted endpoint at `domscan.net/mcp` (Bearer auth). [Product](https://domscan.net)
