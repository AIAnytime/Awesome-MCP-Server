...
- [UnifAPI MCP Server](https://github.com/unifapi-agent/unifapi-mcp-server) — Hosted public-data MCP server for social, search, scrape, news, creator research, and KOL pricing workflows. Remote endpoint at `https://mcp.unifapi.com`; official MCP Registry name `com.unifapi/mcp`. [Docs](https://docs.unifapi.com/mcp)
