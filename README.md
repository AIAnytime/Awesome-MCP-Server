...
- [squirrelscan](https://github.com/squirrelscan/squirrelscan) — Hosted MCP server that audits websites for SEO, performance, security, accessibility, and agent experience (260+ rules) and returns exact fixes for your coding agent. Tools to run audits, poll status, fetch reports, and track issues. Endpoint at `https://mcp.squirrelscan.com/mcp`. Homepage: [squirrelscan.com](https://squirrelscan.com).
